...
class TestSyncRepo:
    ...
    @patch("coder.git_sync._pull", return_value="Pulled latest: abc123")
    ...
    @patch("coder.git_sync._clone", return_value="Cloned https://github.com/org/repo.git")
    ...
    @patch("coder.git_sync._clone", return_value="Cloned url")
